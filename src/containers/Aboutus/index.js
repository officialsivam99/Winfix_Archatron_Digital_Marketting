      ...
      <Container className="py-5">
        ...
        <Row className="g-4">
          {[
            ...
            { name: "Michael Brown", role: "Lead Developer", img: "https://randomuser.me/api/portraits/men/65.jpg" },
            { name: "Emily Wilson", role: "Marketing Manager", img: "https://randomuser.me/api/portraits/women/55.jpg" }
          ].map((member, idx) => (
            <Col md={3} key={idx}>
              <Card bg="dark" text="light" border="light" className="h-100 text-center">
