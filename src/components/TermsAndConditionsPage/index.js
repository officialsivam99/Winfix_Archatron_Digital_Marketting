          ...
          <Col xs={12}>
            ...
            >
              ...
              <ul>
                ...
                <li>
                  <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Digital Impact.
                </li>
                <li>
                ...
                <li>
                  ...
                  <a href="http://onlinedigitalimpact.com" target="_blank" rel="noreferrer">
              ...
              {/* Acknowledgment */}
              <div style={styleSet.sectionTitle}>Acknowledgment</div>
              <p>
              ...
              <div style={styleSet.sectionTitle}>Links to Other Websites</div>
              <p>
              ...
              {/* Termination */}
              <div style={styleSet.sectionTitle}>Termination</div>
              <p>
              ...
              <div style={styleSet.sectionTitle}>"AS IS" and "AS AVAILABLE" Disclaimer</div>
              <p>
              ...
              <p>
                Without limitation to the foregoing, the Company provides no warranty or undertaking, and makes no representation of any kind that the
                Service will meet Your requirements, achieve any intended results, be compatible or work with any other software, applications, systems
                or services, operate without interruption, meet any performance or reliability standards or be error free or that any errors or defects
                can or will be corrected.
              </p>
              <p>
                Without limiting the foregoing, neither the Company nor any of the Company's providers makes any representation or warranty of any kind,
              ...
              {/* Disputes Resolution */}
              <div style={styleSet.sectionTitle}>Disputes Resolution</div>
              <p>
                If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.
              </p>

              {/* EU Users */}
              <div style={styleSet.sectionTitle}>For European Union (EU) Users</div>
              <p>
                If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which You are resident.
              </p>

              {/* US Compliance */}
              <div style={styleSet.sectionTitle}>United States Legal Compliance</div>
              <p>
              ...
              <div style={styleSet.sectionTitle}>Severability and Waiver</div>
              <h5>Severability</h5>
              <p>
                ...
                objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full
                force and effect.
              </p>
              <h5>Waiver</h5>
              <p>
              ...
              <div style={styleSet.sectionTitle}>Translation Interpretation</div>
              <p>
              ...
              {/* Changes */}
              <div style={styleSet.sectionTitle}>Changes to These Terms and Conditions</div>
              <p>
              ...
              <ul>
                <li>
                  By email: <strong>info@onlinedigitalimpact.com</strong>
                </li>
              </ul>
            </div>
          </Col>
